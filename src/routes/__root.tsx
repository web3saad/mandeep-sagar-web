  ...
  head: () => ({
    meta: [
      ...
      { title: "Dr. Mandeep Sagar — Interventional Neuroradiologist" },
      {
        name: "description",
        content:
          "Dr. Mandeep Sagar — minimally invasive neurovascular and interventional treatments for stroke, aneurysms, AVMs and complex vascular conditions.",
      },
      ...
      { property: "og:title", content: "Dr. Mandeep Sagar — Interventional Neuroradiologist" },
      {
        ...
        content:
          "Minimally invasive neurovascular care. Book a consultation or upload your reports for a second opinion.",
      },
